...
import { LayoutDashboard, Briefcase, Wallet, Calendar, ShieldCheck, Shield, Star, PlayCircle, LifeBuoy, MapPin, DollarSign, CheckCircle2, XCircle } from "lucide-react";
      ...
      {tab === "earnings" && (
        <div className="space-y-6">
          <div className="grid sm:grid-cols-3 gap-4">
            <StatCard icon={DollarSign} label="This week" value="₹4,820" />
            <StatCard icon={DollarSign} label="This month" value="₹18,650" delay={0.05} />
            <StatCard icon={Wallet} label="Available for payout" value="₹3,200" delay={0.1} />
          </div>
          <div className="rounded-2xl border border-line dark:border-slate-800 bg-white dark:bg-slate-900 p-6">
